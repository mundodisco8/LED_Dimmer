#ifndef _NVIC_STUFF_H_
#define _NVIC_STUFF_H_

#include <inttypes.h>

// I just need somewhere to put the interrupt enable function for now
void NVIC_EnableIRQ(int32_t irqn);

// This define doens't go here, but it's easier than pulling a 100 SDK files to get it, and it's just an integer...
typedef enum IRQn{
