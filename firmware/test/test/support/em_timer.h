...
/*****************************************************************************************
 *
 * FAKE EM_TIMER.H USED IN TESTS. CONTAINS THE MINIMUM AMOUNT OF IT TO RUN THEM
 *
 ****************************************************************************************/
#include <stdbool.h>
...
// #define _TIMER_CC_CFG_MODE_MASK 0x3UL
...
// #define _TIMER_CC_CFG_INSEL_MASK 0x60000UL
...
// /** Prescaler. */
// #define _TIMER_CFG_PRESC_MASK 0xFFC0000UL
...
// /** Clock select. */
// #define _TIMER_CFG_CLKSEL_MASK 0x300UL
...
// /** Timer mode. */
// #define _TIMER_CFG_MODE_MASK 0x3UL
...
// #define TIMER_CTRL_X2CNT (0x1UL << 4)
// #define TIMER_CFG_ATI TIMER_CFG_DISSYNCOUT
// #define TIMER_CFG_RSSCOIST (0x1UL << 17)
// #define TIMER_CFG_DISSYNCOUT (0x1UL << 11)
// typedef struct {
...
// #if defined(TIMER_CTRL_X2CNT) && (defined(TIMER_CTRL_ATI) || defined(TIMER_CFG_ATI)) && (defined(TIMER_CTRL_RSSCOIST) || defined(TIMER_CFG_RSSCOIST))
...
// #ifdef defines
// #define TIMER_NUM(ref) (((ref) == TIMER0) ? 0 : -1)
...
// // #ifdef initcc
// // void joel(TIMER_InitCC_TypeDef* test2);
// // #endif
// // #ifdef timerinit
// // void joel1(TIMER_TypeDef* test);
// // void joel2(TIMER_InitCC_TypeDef* test2, TIMER_TypeDef* test);
// // #endif
