...
// timerHandlePtr_t is an incomplete type, used to share pointers to sl_sleeptimer handlers without having to export
// the SDK files
typedef struct timerHandle* timerHandlePtr_t;
