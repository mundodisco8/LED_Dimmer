...
extern sl_iostream_t *sl_iostream_debugSerial_handle;
extern sl_iostream_uart_t *sl_iostream_uart_debugSerial_handle;
extern sl_iostream_instance_info_t sl_iostream_instance_debugSerial_info;
