#ifndef SL_EMLIB_GPIO_INIT_BTN1_PIN_CONFIG_H
#define SL_EMLIB_GPIO_INIT_BTN1_PIN_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_BTN1_PIN_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_BTN1_PIN_MODE        gpioModeInput

// <o SL_EMLIB_GPIO_INIT_BTN1_PIN_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_BTN1_PIN_DOUT        1
...
// <gpio> SL_EMLIB_GPIO_INIT_BTN1_PIN
// $[GPIO_SL_EMLIB_GPIO_INIT_BTN1_PIN]
#define SL_EMLIB_GPIO_INIT_BTN1_PIN_PORT         gpioPortC
#define SL_EMLIB_GPIO_INIT_BTN1_PIN_PIN          5
// [GPIO_SL_EMLIB_GPIO_INIT_BTN1_PIN]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_BTN1_PIN_CONFIG_H
